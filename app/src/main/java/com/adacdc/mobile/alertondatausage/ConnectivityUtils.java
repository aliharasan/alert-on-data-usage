...
/**
 * Created by ali on 12/20/15.
 */
public class ConnectivityUtils {

    public static final String WIFICONNECTION = "WIFI";
    public static final String DATACONNECTION = "DATA";
    public static final String CONNECTION = "connected";



    public static String KindOfConnection(Context context) {
